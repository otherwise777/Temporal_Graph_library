 ...
 *
 */
public class SingleSourceShortestTemporalPathEAT<K,EV> implements TGraphAlgorithm<K,Double,EV,Double,DataSet<Vertex<K,Double>>> {
    ...
    @Override
    public DataSet<Vertex<K,Double>> run(Tgraph<K, Double, EV, Double> input) throws Exception {
